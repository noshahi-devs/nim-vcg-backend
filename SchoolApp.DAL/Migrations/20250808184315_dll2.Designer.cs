            ...
            modelBuilder.Entity("SchoolApp.Models.DataModels.Mark", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Feedback = "Good job!",
                            Grade = 1,
                            MarkEntryDate = new DateTime(2025, 8, 8, 23, 43, 13, 213, DateTimeKind.Local).AddTicks(9702),
                            ObtainedScore = 65,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 1,
                        ...
                        new
                        {
                            ...
                            Grade = 0,
                            MarkEntryDate = new DateTime(2025, 8, 8, 23, 43, 13, 213, DateTimeKind.Local).AddTicks(9707),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 2,
                        ...
                        new
                        {
                            ...
                            Feedback = "Excellent work!",
                            Grade = 0,
                            MarkEntryDate = new DateTime(2025, 8, 8, 23, 43, 13, 213, DateTimeKind.Local).AddTicks(9710),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 3,
